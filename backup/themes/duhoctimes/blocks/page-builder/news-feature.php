...
class Bunyad_PageBuilder_NewsFeature extends Bunyad_PageBuilder_WidgetBase
{
	...
	{
		parent::__construct(
			'bunyad_pagebuilder_news_feature',
			__('News Feature Block', 'bunyad-admin'),
	...
	public function widget($args, $instance)
	{
		...
		echo '[news_feature '. implode(' ', $this->shortcode_attribs($instance, $attrs)) .' /]';
