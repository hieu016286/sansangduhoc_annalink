...
<div <?php Bunyad::markup()->attribs('navigation-wrap', $wrap_attribs); ?>>
	...
	<div id="vip_banner">
		<ul>
			<li><?php echo adrotate_ad(4);?></li>
			<li><?php echo adrotate_ad(7);?></li>
			<li><?php echo adrotate_ad(8);?></li>
		</ul>
	</div>
	<!--<div class="banner"><a href="http://sansangduhoc.vn/tin-tuc/du-hoc-he-cung-annalinkoshcstudents-mo-canh-cua-tuong-lai.html">
		<img class="img-responsive" src="http://sansangduhoc.vn/wp-content/themes/duhoctimes/images/plan-banner.jpg"/>
	</a></div>-->
