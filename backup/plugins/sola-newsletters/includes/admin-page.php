...
<div class="wrap">   
    ...
    <h2>
        ...
        <?php 
            if (!function_exists("sola_nl_register_pro_version") && (get_option("wplc_review_message") !== "set")) { ?>
    <div class='updated' id='wplc_review_div' style='padding:10px;'>
        <h1><?php _e("Get the Pro version for free!","sola"); ?></h1>
        <p>
            <?php _e("If you are enjoying the plugin, please <a href='https://wordpress.org/support/view/plugin-reviews/sola-newsletters#postform' target='_BLANK'>review Nifty Newsletters on wordpress.org</a> and we'll send you a copy of the <strong><a href='http://solaplugins.com/plugins/sola-newsletters/?utm_source=plugin&utm_medium=link&utm_campaign=review_message' target='_BLANK'>Pro version</a> (worth $20) for free!</strong> Once done, email a screenshot of your review to <a href='mailto:support@solaplugins.com'>support@solaplugins.com</a> and we'll send you a <strong>100% off coupon</strong>.","sola"); ?>
        </p>
        <p>
            <?php _e("If you are experiencing issues with the plugin, please email us on the above email and we'll get back to you as soon as possible!","sola"); ?>
        </p>
        <a href='https://wordpress.org/support/view/plugin-reviews/sola-newsletters#postform' class='button button-secondary' target='_BLANK'><?php _e("Review the plugin","sola"); ?></a>  <a href='javascript:void(0);' id='wplc_close_review' class='button button-secondary'><?php _e("Close","sola"); ?></a>
    </div>
