    ...
    jQuery.ajax({
        ...
        success: function (response) {
			...
			if(response != null){
				...
				document.getElementById('currentlimit').value = currentlimit;
				document.getElementById('logsection').style.display = "";
				document.getElementById('inserted').value = 0;
				document.getElementById('updated').value = 0;
				document.getElementById('skipped').value = 1;
				jQuery('#innerlog').prepend(jQuery("Skiped <br>"));
			}
