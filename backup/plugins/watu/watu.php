...
function watu_add_menu_links() {
	...
	add_menu_page(sprintf(__('Quản lý câu hỏi', 'watu'), ucfirst(WATU_QUIZ_WORD_PLURAL)), sprintf(__('Quản lý câu hỏi', 'watu'), ucfirst(WATU_QUIZ_WORD_PLURAL)), $view_level, 'watu_exams', 'watu_exams');
	add_submenu_page('watu_exams', __('Cài đặt', 'watu'), __('Cài đặt', 'watu'), $view_level , 'watu_options', 'watu_options');	
