<div class="wrap">
	...
	<div class="postbox-container" style="width:100%;margin-right:2%;">
		...
		<p><b>[watu-takings]</b> <?php printf(__('Displays the table of results on a %s. Get the specific shortcode for each %s from its "View results" page.', 'watu'), WATU_QUIZ_WORD, WATU_QUIZ_WORD);?></p>
