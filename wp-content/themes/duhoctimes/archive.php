...
<div class="main wrap cf">
	<div class="row">
		...
		<?php if (is_tag()): ?>
			...
			<h2 class="main-heading"><?php printf(__('Chuyên mục: %s', 'bunyad'), '<strong>' . single_tag_title( '', false ) . '</strong>'); ?></h2>
		...
		<?php elseif (is_category()): // category page ?>
			...
			<h2 class="main-heading"><?php printf(__('Chuyên mục: %s', 'bunyad'), '<strong>' . single_cat_title('', false) . '</strong>'); ?></h2>
		...
		<?php elseif (is_tax()): // custom taxonomies ?>
			...
			<h2 class="main-heading"><?php printf(__('Chuyên mục: %s', 'bunyad'), '<strong>' . single_term_title('', false) . '</strong>'); ?></h2>
		...
		if(in_array($cat->category_parent,array(185))):
		?>
		<?php 
