...
?>
		<div class="heading cf">
			...
			<a href="<?php comments_link(); ?>" class="comments"> <?php echo get_comments_number();?> <i class="fa fa-comments-o"></i> <?php echo ' ';echo getPostViews($post->ID);?></a>
		...
		<div class="post-meta cf">
			...
			-->
			<span class="posted-on"><?php echo sw_get_current_weekday(date('l', strtotime(get_the_date('Y-m-d')))); //_ex('on', 'Post Meta', 'bunyad'); ?>
