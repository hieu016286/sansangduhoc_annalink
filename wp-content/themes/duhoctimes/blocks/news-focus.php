...
<?php
	// add by Bach 28/5/2018
	if($taxonomy->term_id == 161){
?>
	...
	<div class="row news-<?php echo $id; ?> highlights">
		...
		<?php
			...
			<article itemscope itemtype="http://schema.org/Article">
				...
				<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" class="image-link <?php echo (has_post_thumbnail())?'':'no-thumb'?>" itemprop="url">
		...
		<?php while ($query->have_posts()): $query->the_post(); ?>
			...
			<?php if ($the_block == 'news-focus'): // other posts, in a list ?>
				...
				<li>
					...
					<div class="content <?php echo (has_post_thumbnail())?'':'no-thumb'?>">
