...
class Bunyad_PageBuilder_NewsFaq extends Bunyad_PageBuilder_WidgetBase
{
	...
	{
		parent::__construct(
			'bunyad_pagebuilder_news_faq',
			__('News Faq Block', 'bunyad-admin'),
	...
	public function widget($args, $instance)
	{
		...
		echo '[news_faq '. implode(' ', $this->shortcode_attribs($instance, $attrs)) .' /]';
	...
	<p class="description"><?php _e('News Faq blocks displays sub-categories as tabs. Select any sub-category you wish to display.', 'bunyad-admin'); ?></p>
