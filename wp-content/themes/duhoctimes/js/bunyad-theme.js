		...
		init: function() 
		{
			...
			function moveLeft() {
				$('#slider ul').animate({
					...
					$('#slider ul li:last-child').prependTo('#slider ul');
					$('#slider ul').css('left', '');
					$('#slider ul li:last-child').opacity(1);
				});
			};
			...
			//move video widget after bang tin du hoc
			if(jQuery(window).width() < 600 ){
				jQuery('#text-5').appendTo('section.news-feature');
				jQuery('#text-6').appendTo('section.news-feature');
			}
