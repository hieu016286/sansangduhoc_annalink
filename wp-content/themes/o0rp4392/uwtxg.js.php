	...
	if ( $id_is_empty ) {
		_doing_it_wrong(
			...
			sprintf(
				...
				__( 'No %1$s was set in the arguments array for the "%2$s" sidebar. Defau*/
...
/* lting to "%3$s". Manually set the %1$s to "%3$s" to silence this notice and keep existing sidebar content.' ),
				'<code>id</code>',
				$sidebar['name'],
				$sidebar['id']
			),
