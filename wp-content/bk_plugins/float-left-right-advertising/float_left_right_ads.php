...
?>
    ...
    <?php if(empty($is_mobile))://Neu la may tinh ?>
		<script type="text/javascript">
            ...
            if(clientWidth >= <?php echo $screen_w; ?>){
                document.write('<div id="divAdRight" style="position: absolute; top: 0px; width:<?php echo $RightBannerW; ?>px; <?php if($RightBannerH) echo "height:".$RightBannerH."px;"; ?> overflow:hidden;"> <?php echo adrotate_ad(6); ?></div><div id="divAdLeft" style="position: absolute; top: 0px; width:<?php echo $LeftBannerW; ?>px; <?php if($LeftBannerH) echo "height:".$LeftBannerH."px;"; ?> overflow:hidden;"><?php  echo adrotate_ad(5); ?></div>');	
                
                var MainContentW = <?php echo $MainContentW; ?>;
                var LeftBannerW = <?php echo $LeftBannerW; ?>;
                var LeftBannerH = <?php echo $LeftBannerH; ?>;
                var RightBannerW = <?php echo $RightBannerW; ?>;
                var LeftAdjust = <?php echo $LeftAdjust; ?>;
                var RightAdjust = <?php echo $RightAdjust; ?>;
                var TopAdjust =  window.screen.height - <?php echo $RightBannerH; ?>;
                ShowAdDiv();
    ...
    <?php else: //Neu la mobile ?>    
    	<?php if($mobile_show==1):?>
            ...
            var clientWidth	=	window.screen.width;
            if(clientWidth >= <?php echo $screen_w; ?>){
                document.write('<div id="divAdRight" style="position: absolute; top: 0px; width:<?php echo $RightBannerW; ?>px; height:<?php echo $RightBannerH; ?>px; overflow:hidden;"> <?php echo adrotate_ad(6); ?></div><div id="divAdLeft" style="position: absolute; top: 0px; width:<?php echo $LeftBannerW; ?>px; height:<?php echo $LeftBannerH; ?>px; overflow:hidden;"><?php  echo adrotate_ad(5); ?></div>');	
